...
* **Physical Facts (`measurements`)**: Deterministic metrics computed via Python (FFprobe, PySceneDetect, Whisper) - cuts per second, words per minute, speech ratio, and duration.
...
* **Tab 1: 📊 Overview & Metrics**: Executive metrics overview (averages of WPM, cut cadence, speech ratio, total view volume) and integrated tabular view.
...
* **Tab 3: 📈 Performance Insights & Cross-Analysis**: Cross-analysis of hook mechanisms, pacing correlations, and longitudinal view evolution over time.
